...
//		String arg = "ontologies/claros/Claros.owl ontologies/claros/data"; 
	...
	private static void outputStatistics(OWLOntology onto) {
		System.out.println("TBox: " + onto.getTBoxAxioms(Imports.INCLUDED).size() +
				"\tRBox: " + onto.getRBoxAxioms(Imports.INCLUDED).size() + 
				"\tABox: " + onto.getABoxAxioms(Imports.INCLUDED).size());
		System.out.println("Class Assertions: " + onto.getAxiomCount(AxiomType.CLASS_ASSERTION, Imports.INCLUDED) + 
				"\tObject Property Assertions: " + onto.getAxiomCount(AxiomType.OBJECT_PROPERTY_ASSERTION, Imports.INCLUDED)); 
	}

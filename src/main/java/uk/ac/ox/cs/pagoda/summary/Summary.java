...
public class Summary {
	...
	private void process(OWLOntology ontology, OWLOntology abstractOntology) {
		...
		manager.addAxioms(abstractOntology, ontology.getRBoxAxioms(Imports.INCLUDED)); 
		manager.addAxioms(abstractOntology, ontology.getTBoxAxioms(Imports.INCLUDED));

		OWLAxiom newAxiom; 
		for (OWLAxiom axiom: ontology.getABoxAxioms(Imports.INCLUDED)) {
